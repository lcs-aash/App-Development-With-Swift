 ...
 */
// Create two constants with values of 10 and 20
let width = 10
let height = 20
let area = 10 * height
print(area)
 ...
 */
// Divide in area in half for two rooms
let roomArea = area / 2
print(roomArea)
/*:
 ...
 */
// Create two constants with values of 10 and 3
